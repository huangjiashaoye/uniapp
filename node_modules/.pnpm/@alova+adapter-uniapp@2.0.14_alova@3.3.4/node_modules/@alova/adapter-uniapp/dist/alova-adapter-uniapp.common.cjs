...
const requestAdapter = (elements, method) => {
    ...
    let taskInstance;
    let onDownload = shared.noop;
    let onUpload = shared.noop;
...
var statesHook = {
    ...
    effectRequest(effectRequestParams, referingObject) {
        ...
        effectRequestParams.handler = (...args) => {
            ...
            shared.len(args) > 0 ? handler(...args) : Promise.resolve().then(() => handler(...args));
        };
...
exports.default = AdapterUniapp;
exports.uniappL2CacheAdapter = l2CacheAdapter;
exports.uniappMockResponse = mockResponseHandler;
exports.uniappRequestAdapter = requestAdapter;
