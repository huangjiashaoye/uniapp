 ...
 * HarmonyOS 启动界面配置
 */
interface HarmonySplashScreens {
    /**
     * 启动界面背景色
     *
     * 格式为 #RRGGBB
 ...
 * HarmonyOS 元服务签名配置
 */
interface MpHarmonySigningConfig {
    /**
     * 私钥库文件
     *
     */
...
export { VitePluginUniManifest, defineManifestConfig };
export type { AndroidFeature, AndroidFeatureName, AndroidPermission, AndroidPermissionName, AndroidPermissionOrFeature, AppHarmony, AppPlus, Color, H5, HEXColor, HarmonyDistribute, HarmonyIcons, HarmonyModules, HarmonySigningConfig, HarmonySplashScreens, HarmonyUserAgent, ManifestConfig, MpAlipay, MpBaidu, MpHarmony, MpHarmonyDistribute, MpHarmonySigningConfig, MpKuaishou, MpLark, MpQq, MpToutiao, MpWeixin, PNG, PercentageSize, PlatformUniStatistics, PxSize, QuickappWebview, QuickappWebviewHuawei, QuickappWebviewUnion, RGBAColor, RGBColor, RpxSize, UniStatistics, UserManifestConfig };
